...
// ATENÇÃO: colocar dentro de uma função que é chamada apenas quando estiver na tela de Projects para melhor peformance

export default function initBgProjects() {
